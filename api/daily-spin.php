...
$PRIZES = [
    ["name" => "100 Coins", "type" => "coins", "amount" => 100, "weight" => 25, "color" => "#ffd700"],
    ["name" => "250 Coins", "type" => "coins", "amount" => 250, "weight" => 20, "color" => "#ffd700"],
    ["name" => "500 Coins", "type" => "coins", "amount" => 500, "weight" => 15, "color" => "#ffd700"],
    ["name" => "1000 Coins", "type" => "coins", "amount" => 1000, "weight" => 8, "color" => "#ffd700"],
    ["name" => "Basic Box", "type" => "lootbox", "boxType" => "basic", "weight" => 12, "color" => "#60a5fa"],
    ["name" => "Premium Box", "type" => "lootbox", "boxType" => "premium", "weight" => 5, "color" => "#a855f7"],
    ["name" => "2x XP (1hr)", "type" => "boost", "boostType" => "xp_2x", "weight" => 8, "color" => "#4ade80"],
    ["name" => "Try Again", "type" => "nothing", "weight" => 7, "color" => "#666"]
];
